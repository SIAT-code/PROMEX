...
def parse_args():
    ...
    ################################## mark add parameters for MetaMoE #####################################################
    parser.add_argument('--teacher_name', '-tn', type=str, default='moe3',
                        help='name of teacher model')
    parser.add_argument('--teacher_checkpoint', '-tckpt', type=str,
                        default='../2_Property/1_Teacher/weights/Secondary-Structure-adapt/esm2_t33_650M_UR50D.pt',
                        help='name of teacher model checkpoint')
    ########################################################################################################################
...
if __name__ == '__main__':
    args = parse_args()
    assert args.train_size in config.splits
