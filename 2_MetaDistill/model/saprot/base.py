...
class SaprotBaseModel(AbstractModel):
    ...
    def __init__(self,
        ...
        """
        assert task in ['classification', 'regression', 'lm', 'base', 'token_classification']  # mark
        self.task = task
    ...
    def _init_lora(self, lora_config_path):
        ...
        # self.init_optimizers()  # mark 注释掉，自定义了一个 "for lora"
    ...
    def initialize_model(self):
        ...
        #-------------------------------- mark Add token-level task ----------------------------------------------#
            ...
            if self.load_pretrained:
                ...
                config.num_labels = self.num_labels
                self.model = EsmForTokenClassification(config)
        #--------------------------------------------------------------------------------------------------------#
