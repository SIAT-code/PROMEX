...
class MetaSaprotClassificationDataset(Dataset):
    ...
    def init_indices(self):
        ...
        self.adapt_indices = self.indices[:split_idx]
        self.eval_indices = self.indices[split_idx:]
        
        self.adapt_dataset.indices = self.adapt_indices
        self.adapt_dataset.length = self.dataloader_kwargs['adapt_batch_size'] * self.dataloader_kwargs['adapt_steps']
        self.eval_dataset.indices = self.eval_indices
        self.eval_dataset.length = self.dataloader_kwargs['eval_batch_size']
