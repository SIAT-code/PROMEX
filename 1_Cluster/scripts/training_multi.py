...
def get_args():
    ...
    parser.add_argument('--train_lmdb', help="train lmdb", type=str, required=True)
    parser.add_argument('--valid_lmdb', help="valid lmdb", type=str, required=True)
    parser.add_argument('--test_lmdb', help="test lmdb", type=str, required=True)
    parser.add_argument('--save_path', help="save path", type=str, required=True)
...
def main(args):
    ...
    config.dataset.valid_lmdb = args.valid_lmdb
