...
class SaprotRegressionModel(SaprotBaseModel):
    ...
    def validation_epoch_end(self, outputs):
        ...
        train_log_dict = self.train_log_dict if self.train_log_dict else {'train_loss': 0.0, 'train_spearman': 0.0, 'train_R2': 0.0, 'train_pearson': 0.0}  # mark add
        self.log_info(log_dict)
        ...
        self.train_state['valid'].append({'epoch': self.epoch + 1, 
                                        ...
                                        'train_R2': train_log_dict['train_R2'].item(), 'train_pearson': train_log_dict['train_pearson'].item(), \
